...
theta_init=0.5 #Her må vi ha en vinkel>0 slik at løkken ikke repeterer tomme lister
...
plt.figure(0)
plt.plot(t_verdier[0:z+1],(EK_trans[0:z+1]+EP[0:z+1]),color='orange',label="Total energi (J)")
plt.plot(t_verdier[0:z+1],EK_trans[0:z+1],color='purple',label="Kinetisk energi (J)")
plt.plot(t_verdier[0:z+1],EP[0:z+1],color='green',label="Potensiell energi (J)")
plt.grid(True)
plt.xlabel("Tid (s)")
plt.ylabel("Energi (J)")
